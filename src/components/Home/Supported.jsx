...
const Supported = () => {
  return (
    <section className={style["wallet-support"]}>
        ...
        <p className={style["wallet-support-text"]}>DappsChainFortify enables seamless integration of your wallet with an extensive collection of applications, unlocking a multitude of web3 opportunities.</p>
